...
def Work(sprint_out_dir,a):
    ...
    if os.path.exists(sprint_out_dir+'/AEI/EditingIndex.csv') == False:
        ...
        subprocess.Popen('python /lustre/tianlab/a_pengying/scr/AEI_mine.py '+sprint_out_dir+'/AEI/a/a_ucscHg38Alu.bed.gz_mpileup_strand_1.cmpileup '+sprint_out_dir+'/AEI/a/a_ucscHg38Alu.bed.gz_mpileup_strand_2.cmpileup '+sprint_out_dir+'/SPRINT_identified_regular.res '+sprint_out_dir+'/aei.txt', shell=True).wait()
